...
class RegularStoryCollectionViewCell: BaseCollectionViewCell {
    private(set) var storyModel: StoryModel?
    ...
    internal func set(_ storyModel: StoryModel, imageService: ImageService) {
    ...
    override func configureLayout() {
        ...
        self.coverImageViewConstraints = [
            ...
            self.coverImageView.trailingAnchor.constraint(equalTo: self.contentView.trailingAnchor, constant: 0),
            self.coverImageView.heightAnchor.constraint(equalTo: self.coverImageView.widthAnchor, multiplier: (9 / 6))
        ]
        
        self.titleLabelConstraints = [
            self.titleLabel.topAnchor.constraint(equalTo: self.coverImageView.bottomAnchor, constant: 8),
            self.titleLabel.leadingAnchor.constraint(equalTo: self.coverImageView.leadingAnchor, constant: 0),
            self.titleLabel.trailingAnchor.constraint(equalTo: self.coverImageView.trailingAnchor, constant: 0),
        ]
